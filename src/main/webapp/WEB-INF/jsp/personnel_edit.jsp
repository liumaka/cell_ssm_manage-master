                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item" hidden>
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="oid" autocomplete="off" placeholder="房产编码"
                                   class="layui-input" value="${ownerInfo.id}">
                        </div>
                    </div>
                        ...
                        <div class="layui-input-block">
                            <select name="cid" id="cid">
                                <c:forEach var="comInfo" items="${communityInfo}">
                                    <c:if test="${comInfo.id == ownerInfo.cid}">
                        ...
                        <div class="layui-input-block">
                            <select name="hid" id="hid">
                                <c:forEach var="houInfo" items="${houseInfo}">
                                    <c:if test="${houInfo.id == ownerInfo.hid}">
                                        <option value="${houInfo.id}" selected>${houInfo.hname}</option>
                                    </c:if>
                                    <c:if test="${houInfo.id != ownerInfo.hid}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="oname" autocomplete="off" placeholder="输入成员名称"
                                   class="layui-input" lay-verify="required" lay-reqtext="成员名称是必填项，岂能为空？"
                                   value="${ownerInfo.oname}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="idcard" autocomplete="off" placeholder="请输入身份证号码"
                                   class="layui-input" maxlength="18" lay-verify="identity" value="${ownerInfo.idcard}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" name="birthday" placeholder="出生日期" id="LAY_demorange_s"
                                   value="${ownerInfo.birthday}" pattern="yyyy-MM-dd">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="telephone" autocomplete="off" placeholder=""
                                   class="layui-input" maxlength="11" lay-verify="required|phone"
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="profession" autocomplete="off" placeholder=""
                                   class="layui-input" value="${ownerInfo.profession}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="sex" value="0" title="男"  <c:if test="${ownerInfo.sex == '0' }">checked="checked"</c:if> >
                            <div class="layui-unselect layui-form-radio layui-form-radioed"><i
                                    class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                <div>男</div>
                            </div>
                            <input type="radio" name="sex" value="1" title="女" <c:if test="${ownerInfo.sex == '1' }">checked="checked"</c:if>>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="personnel_type" value="0" title="业主" <c:if test="${ownerInfo.type == '0' }">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio layui-form-radioed"><i
                                    class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                <div>业主</div>
                            </div>
                            <input type="radio" name="personnel_type" value="1" title="家庭成员"<c:if test="${ownerInfo.type == '1' }">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i>
                                <div>家庭成员</div>
                            </div>
                            <input type="radio" name="personnel_type" value="2" title="租户"<c:if test="${ownerInfo.type == '2' }">checked="checked"</c:if>>
                            <div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i>
                                <div>租户</div>
                            </div>
                        </div>
...
<%--                                                    class="layui-icon">ဂ</i>撤销上传</a>--%>
                                        ...
                                        <div class="layui-form-item imgs" id="imgshow" style="display: block;">
                                            ...
                                            <img src="${pageContext.request.contextPath}/images/${ownerInfo.picture}" id="pimages" name="pimages" style="width: 400px;height: 200px;"/>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea placeholder="请输入内容" name="remark"
                                      class="layui-textarea">${ownerInfo.remark}</textarea>
                        </div>
                    </div>
