    ...
    <div class="layui-header header header-demo">
        <div class="layui-main">
            <div class="admin-logo-box">
                <a class="logo" href="" title="logo">小区管理系统</a>
            ...
            <ul class="layui-nav" lay-filter="">
                ...
                <li class="layui-nav-item"><img src="${pageContext.request.contextPath}/images/${user.img}" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" height="35px" alt=""></li>
                ...
                <li class="layui-nav-item"> <a href="javascript:;">${loginName.realname}</a>
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd><a href="javascript:;"  onclick="one_set('个人信息','./one_set','1000','600')">个人信息</a>
                        </dd>
    ...
    <div class="layui-side layui-bg-black x-side show_list" style="left:0px;" id="table1">
        <div style="height: 130px; width: 220px; ">
            <a class="img" title="我的头像" style="display: block;width: 80px;height: 80px;margin: 10px auto 10px;">
                <img src="${pageContext.request.contextPath}/images/${user.img}" class="userAvatar" style="display: block;width: 100%;height: 100%;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;border: 4px solid #44576b;box-sizing: border-box;">
            </a>
            <p style=" display: block;width: 100%;height: 25px;color: #ffffff;text-align: center;font-size: 12px;white-space: nowrap;line-height: 25px;overflow: hidden;">
                你好！<span class="userName">${loginName.realname}</span>, 欢迎回来
            </p>
        </div>
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;" _href="./welcome"> <i class="layui-icon left-nav-li" lay-tips="首页">&#xe68e;</i><cite>控制台</cite> </a>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="iconfont icon-dashaxiaoqudizhi01" style="top: 3px;"></i><cite>小区管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="./communitylist?pageNum=1"> <cite>小区列表</cite> </a> </dd>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-lvhuaxiaoqu" style="top: 3px;"></i><cite>房产管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="./homelist"> <cite>房产管理</cite> </a> </dd>
                        </dd>
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="./buildinglst"> <cite>栋数管理</cite> </a> </dd>
                        </dd>
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-yezhuxian" style="top: 3px;"></i><cite>业主信息管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class=""> <a href="javascript:;" _href="./personnel_list"> <cite>人员管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="./vehicle_list"> <cite>车辆管理</cite> </a> </dd>
                        <dd class=""> <a href="javascript:;" _href="./pet_list"> <cite>宠物管理</cite> </a> </dd>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-tingchewei" style="top: 3px;"></i><cite>停车位管理</cite> </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                ...
                <li class="layui-nav-item"> <a class="javascript:;" href="javascript:;"> <i class="layui-icon iconfont icon-shoufeizhan" style="top: 3px;"></i><cite>收费管理</cite> </a>
                    <dl class="layui-nav-child">
